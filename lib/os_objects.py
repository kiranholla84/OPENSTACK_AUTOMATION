    ...
    class VolumeOperations(object):
        ...
        def __init__(self, bootable_factor, size_vol, type_vol, volume_name_prefix, replication_factor=None, number_of_volumes=1):
        ...
        def volume_type_return(self, replication_type):
            ...
            if replication_type == 'replicated':
                ...
                print "DEBUG:%s" %random.choice(self.non_replication_list)
        ...
        def volumes_create(self):
            ...
            for volume_index in range(0, self.number_of_volumes - 1):
                ...
                print "INPUTS TO CREATE VOLUME %s %s %s" %(self.volume_name[volume_index], self.size_vol[volume_index], self.type_vol[volume_index]  )
